...
export type Customization = MenuComponentCustomization | React.ComponentType | BaseCustomization | LabelCustomization | CommandCustomization | CodeCustomization | ComponentCustomization | CallbackCustomization | string | number | boolean;
